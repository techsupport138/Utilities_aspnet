...
public class DailyPriceController : BaseApiController {
    private readonly IProductRepository<DailyPriceEntity> _repository;

    public DailyPriceController(IProductRepository<DailyPriceEntity> repository) {
