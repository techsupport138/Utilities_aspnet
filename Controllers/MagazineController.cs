...
public class MagazineController : BaseApiController {
    private readonly IProductRepository<MagazineEntity> _repository;

    public MagazineController(IProductRepository<MagazineEntity> productRepository) {
