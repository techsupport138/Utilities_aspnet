...
public class FormController : BaseApiController {
	...
	public ActionResult<GenericResponse<IQueryable<FormFieldEntity>>> ReadFormFieldById(Guid categoryId) => Result(_formRepository.ReadFormFields(categoryId));

	[HttpPost]
	public async Task<ActionResult<GenericResponse<IQueryable<FormEntity>>>> CreateForm(FormCreateDto model) => Result(await _formRepository.UpdateForm(model));
